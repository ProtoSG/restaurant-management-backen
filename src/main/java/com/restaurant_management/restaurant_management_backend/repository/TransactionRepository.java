...
public interface TransactionRepository extends JpaRepository<Transaction, Long> {
  ...
  @Query(value = "SELECT " +
        ...
        "LIMIT 7", 
        nativeQuery = true)
  List<TrendTransactionsWeekDTO> getTotalAmountWeekGroupedByTransactionDate();
  ...
  @Query("SELECT new com.restaurant_management.restaurant_management_backend.dto.TransactionMountGroupByPaymentMethodDTO(" +
            ...
            "GROUP BY t.paymentMethod")
  List<TransactionMountGroupByPaymentMethodDTO> getTotalAmountGroupedByPaymentMethodAndDate(
